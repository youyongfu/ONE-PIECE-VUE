        ...
        <el-dialog :title="title" :visible.sync="open" :before-close="handleClose" append-to-body>
            ...
            <el-form :model="editForm" :rules="editFormRules" ref="editForm" label-width="100px" class="demo-editForm">
                ...
                <el-steps :active="activeNumber" align-center>
                    ...
                    <el-step title="功能"></el-step>
                    <el-step title="经历"></el-step>
                </el-steps>
                ...
                <el-tabs :tab-position="tabPosition" @tab-click="handleClick" v-model="selectLabel" style="margin:30px 20px 30px 15px">
                    ...
                    <el-tab-pane label="基本信息" name="basicInfo">
                        ...
                        <el-form-item label="建造日" prop="birth" label-width="100px">
                        ...
                        <el-form-item label="全长" prop="weight" label-width="100px">
                        ...
                        <el-form-item label="建造者" prop="manufacturer" label-width="100px">
                            <el-input v-model="editForm.manufacturer" autocomplete="off"></el-input>
                        </el-form-item>
                ...
                this.$nextTick(() => {
                    if(id){
                        this.$axios.get('/sys/shipping/info/' + id).then(res => {
                            this.editForm = res.data.data.shipping;
